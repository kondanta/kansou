...
func TestStatsEndpoints_EndToEnd(t *testing.T) {
	...
	t.Run("summary", func(t *testing.T) {
		...
		res := doGet(t, s, "/api/v1/stats", &body)
	...
	t.Run("genres", func(t *testing.T) {
		...
		res := doGet(t, s, "/api/v1/stats/genres", &body)
		if res.StatusCode != http.StatusOK {
			t.Fatalf("status: got %d, want 200", res.StatusCode)
		}
	...
	t.Run("dimensions", func(t *testing.T) {
		...
		res := doGet(t, s, "/api/v1/stats/dimensions", &body)
		if res.StatusCode != http.StatusOK {
			t.Fatalf("status: got %d, want 200", res.StatusCode)
		}
	...
	t.Run("history", func(t *testing.T) {
		...
		res := doGet(t, s, "/api/v1/stats/history", &body)
		if res.StatusCode != http.StatusOK {
			t.Fatalf("status: got %d, want 200", res.StatusCode)
		}
...
func TestStatsEndpoints_DBless(t *testing.T) {
	...
	for _, path := range []string{"/api/v1/stats", "/api/v1/stats/genres", "/api/v1/stats/dimensions", "/api/v1/stats/history"} {
