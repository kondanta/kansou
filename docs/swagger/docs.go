...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/config/dimensions": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Full dimensions map",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.dimensionsUpdatePayload"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.generalPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/config/genre/{key}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Genre key to remove",
                        "name": "key",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/v1/config/genres": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Genre entries and/or governing scalars to update",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.genresUpdatePayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/history/{score_id}/promote": {
            "post": {
    ...
    "definitions": {
        ...
        "server.dimensionsUpdatePayload": {
            "type": "object",
            "properties": {
                "dimensions": {
                    "type": "object",
